...
urlpatterns = [
    ...
    path(
        "product/<int:id>/",
        TemplateView.as_view(template_name="frontend/product.html"),
        name="product-id",
    ),
    path("profile/", TemplateView.as_view(template_name="frontend/profile.html")),
    path(
        "progress-payment/",
        TemplateView.as_view(template_name="frontend/custom-progressPayment.html"),
    ),
    path("sale/", TemplateView.as_view(template_name="frontend/sale.html")),
    path(
        "sign-in/",
        TemplateView.as_view(template_name="frontend/signIn.html"),
        name="sign-in",
    ),
    path(
        "sign-up/",
        TemplateView.as_view(template_name="frontend/signUp.html"),
        name="sign-up",
    ),
]
