...
urlpatterns = [
    ...
    path('product/<int:id>/', TemplateView.as_view(template_name="frontend/product.html"), name='product-id'),
    ...
    path('sign-in/', TemplateView.as_view(template_name="frontend/signIn.html"), name='sign-in'),
    path('sign-up/', TemplateView.as_view(template_name="frontend/signUp.html"), name='sign-up'),
]
